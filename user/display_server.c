...
/* ---- 字体：8x8 内置位图（见上文注释块，含可读 ASCII 字形） ---- */
static const uint8_t font8x8_basic[128][8] = {
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x00 */
  {0x7E,0x81,0xA5,0x81,0xBD,0x99,0x81,0x7E}, /* 0x01 ► */
  {0x7E,0xFF,0xDB,0xFF,0xC3,0xE7,0xFF,0x7E}, /* 0x02 ◄ */
  {0x00,0x00,0x6C,0xFE,0xFE,0x6C,0x00,0x00}, /* 0x03 */
  {0x00,0x00,0x38,0x7C,0x7C,0x38,0x00,0x00}, /* 0x04 */
  {0x1C,0x3E,0x7C,0x1C,0x1C,0x7C,0x3E,0x1C}, /* 0x05 */
  {0x00,0x18,0x3C,0x7E,0x18,0x18,0x18,0x18}, /* 0x06 */
  {0x00,0x66,0x66,0x66,0x66,0x00,0x66,0x00}, /* 0x07 */
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x08 */
  {0x18,0x3C,0x66,0x66,0x66,0x3C,0x18,0x00}, /* 0x09 ● */
  {0x7F,0xC0,0xC0,0x7F,0x03,0x03,0x7F,0x00}, /* 0x0A */
  {0x3E,0x63,0x3E,0x6B,0x6B,0x3E,0x03,0x00}, /* 0x0B */
  {0x00,0x00,0x00,0x00,0x7F,0x7F,0x7F,0x00}, /* 0x0C */
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x0D */
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x0E */
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x0F */
  {0x00,0x00,0x00,0x00,0x00,0x00,0x00,0x00}, /* 0x10 */
  {0x18,0x18,0x18,0x18,0x18,0x00,0x18,0x00}, /* 0x11 ! */
  {0x6C,0x6C,0x6C,0x00,0x00,0x00,0x00,0x00}, /* 0x12 " */
  {0x36,0x36,0x7F,0x36,0x7F,0x36,0x36,0x00}, /* 0x13 # */
